...
!!! note
    This provider has been specifically created for integration with ISync for Gina. As such, there may be aspects of the code which have been tailored for their specific requirement. If needed for another customer please reach out to the development team to discuss. 
